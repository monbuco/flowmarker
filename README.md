...
to write freely without being constrained by layout, pages, or excessive
...
- Content over layout
- No page concept, fluid reading and writing
- Keyboard-first writing
- Clean, durable source formats
- Export to existing standards (Markdown, HTML, EPUB, PDF)
- Desktop-first, digital-native
